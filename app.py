...
<style>
  html, body, [class*="css"], button, label, p, h1, h2, h3, div {
  ...
  [data-testid="stExpander"] { background: #1e293b !important; border: 1px solid #334155 !important; border-radius: 12px !important; margin-bottom: 8px !important; }
  [data-testid="stExpander"] summary { color: #f1f5f9 !important; font-weight: 600; }
  [data-testid="stMetric"] { background: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 16px !important; }
  [data-testid="stMetricValue"] { color: #38bdf8 !important; font-size: 2rem !important; }
  [data-testid="stMetricLabel"] { color: #94a3b8 !important; }
  .stButton > button { background: linear-gradient(135deg,#0ea5e9,#6366f1) !important; color: white !important; border: none !important; border-radius: 10px !important; font-weight: 700 !important; }
...
def check_password():
    ...
    <div style="max-width:400px;margin:80px auto;text-align:center;">
      ...
      <h1 style="color:#f1f5f9;margin-bottom:4px;font-family:Nunito,sans-serif;">Weather Bot</h1>
      <p style="color:#64748b;margin-bottom:32px;font-family:Nunito,sans-serif;">Daily weather briefing dashboard</p>
    </div>""")
...
# ── sidebar ───────────────────────────────────────────────────────────────────
st.sidebar.html("""
<div style="text-align:center;padding:20px 0 16px 0;font-family:Nunito,sans-serif;">
...
# ══════════════════════════════════════════════════════════════════════════════
if page == "📋 Recipients":
    st.html("""<div style="background:linear-gradient(135deg,#1e293b,#0f2744);border-radius:16px;
